  ...
  return (
    <div className="container">
      <div className="row d-flex justify-content-center align-items-center">
        <div className="col-6 col-sm-5 col-md-4 col-lg-3 col-xl-2 my-5 mx-5">
          <Image height={200} src={me} className="circle" />
        </div>
        <div className=" col-7 col-sm-7 col-md-5 col-lg-4 my-5 mx-5  right-card">
          <div className="row">
            <div className="col col-md-10 col-lg-9">{"Joyal Corda."}</div>
          </div>
          <div className="row">
            <div className="col">{"a Web Developer"}</div>
          </div>
